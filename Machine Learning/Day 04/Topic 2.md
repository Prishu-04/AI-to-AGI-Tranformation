...
```
---
## 20. Check Unique Value
![[Pasted image 20260603100446.png]]
count each category:
![[Pasted image 20260603100511.png]]

----
## 21 Check Duplicate Values
![[Pasted image 20260603100617.png]]

---
## 22. Interview Questions
1. Why do we inspect data before cleaning?
2. What does `df.head()` do?
3. What does `df.tail()` do?
4. What does `df.shape` return?
5. What does `df.columns` show?
6. What does `df.dtypes` show?
7. What does `df.info()` show?
8. What does `df.describe()` show?
9. What does `df.isnull().sum()` show?
10. What does `df.duplicated().sum()` show?
11. What does `value_counts()` do?
12. What causes `KeyError` in Pandas?
13. Why should we check categorical columns?
14. Why should we check duplicate rows?
15. Why is data inspection important in ML?
